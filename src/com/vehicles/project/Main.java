...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("El cotxe te la matrúcula: " + cotxe1.getPlate()+ " es de la marca " + cotxe1.getBrand()
		...
		double diametreRodesTraseres=Double.parseDouble(JOptionPane.showInputDialog("Introdueïx el diametre de les rodes traseres"));
		String marcaRodesDavanteres=JOptionPane.showInputDialog("Introdueïx la marca rodes davanteres");
		double diametreRodesDavanteres=Double.parseDouble(JOptionPane.showInputDialog("Introdueïx el diametre de les rodes davanteres"));
